...
$(document).ready(function() {
	...
	$("button.exportcookie").click(function() {
		...
		downloadFile(json, "cookiebro-cookie-" + cookie.domain + "-" + cookie.name + ".json", "application/json");
...
function exportDomainCookies(domain)
{
	...
	if( res.length > 0 ) {
		...
		downloadFile(json, "cookiebro-domaincookies-" + domain + ".json", "application/json");
